...
class NovelImplementationETOnly(BaseCLAlgorithm):
    ...
    def __init__(
        ...
        self.loss_criterion = torch.nn.CrossEntropyLoss() # SupConLoss()

        self.uncertainty_type = "random"
    ...
    def train(self) -> None:
        ...
        for epoch in range(1, self.epochs_per_task + 1):
            ...
            self.writer.add_scalar(f"Loss/Task_{epoch}_Total_avg", avg_running_loss, epoch)
