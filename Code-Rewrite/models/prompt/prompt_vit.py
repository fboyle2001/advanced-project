...
class Encoder(nn.Module):
    ...
    def __init__(
        ...
        self.pos_embedding = nn.parameter.Parameter(torch.empty(1, seq_length, hidden_dim).normal_(std=0.02)) # from BERT
        self.dropout = nn.Dropout(dropout)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        # Add a class token
        self.class_token = nn.parameter.Parameter(torch.zeros(1, 1, hidden_dim))
        seq_length += 1
