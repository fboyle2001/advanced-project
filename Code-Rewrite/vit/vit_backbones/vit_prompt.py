...
from .vit import CONFIGS, Transformer, VisionTransformer, np2th
...
class PromptedTransformer(Transformer):
    def __init__(self, prompt_config, config, img_size, vis):
        ...
        if self.prompt_config.INITIATION == "random":
            ...
            self.prompt_embeddings = nn.parameter.Parameter(torch.zeros(
            ...
            if self.prompt_config.DEEP:  # noqa
                ...
                self.deep_prompt_embeddings = nn.parameter.Parameter(torch.zeros(
            ...
            if i == 0:
                ...
                if i <= self.deep_prompt_embeddings.shape[0]:
                    ...
                    hidden_states = torch.cat((
                        ...
                        deep_prompt_emb,
                        hidden_states[:, (1+self.num_tokens):, :]  # type: ignore
                    ), dim=1)
